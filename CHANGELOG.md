...
* Dummy config directory for the projects module to make it easier for developers to understand and re ([903b4ca](https://github.com/meanjs/mean/commit/903b4ca))
...
* Merge pull request #890 from lirantal/feature/project-module-dummy-config-dir ([bd1a7d7](https://github.com/meanjs/mean/commit/bd1a7d7))
...
* Allow Guests to view Projects ([cbebed9](https://github.com/meanjs/mean/commit/cbebed9))
...
* Merge pull request #781 from codydaig/bug/listProjectsAuth ([0be1b11](https://github.com/meanjs/mean/commit/0be1b11))
...
* BUG: Removed a ng-binding to project.content in user-list.client.view.html ([2747df6](https://github.com/meanjs/mean/commit/2747df6))
...
* Adding karma-ng-html2js-preprocessor to fix karma tests.  Adding user mock to projects tests. ([c468539](https://github.com/meanjs/mean/commit/c468539))
...
* Remove console.log from an project test ([a8dae99](https://github.com/meanjs/mean/commit/a8dae99))
...
* should return done(err) in project server route test ([d00f4ce](https://github.com/meanjs/mean/commit/d00f4ce))
...
* The project middleware was calling getErrorMessage with a null argument, causing a crash when this m ([71167b0](https://github.com/meanjs/mean/commit/71167b0))
